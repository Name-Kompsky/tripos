...
\begin{corollary}[Upward Löwenheim-Skolem]\index{upward Löwenheim-Skolem theorem}
  If a theory \(S\) has in infinite model then it has an uncountable model.
\end{corollary}
...
\begin{corollary}[Downward Löwenheim-Skolem]\index{downward Löwenheim-Skolem theorem}
...
Note that this \emph{is} examinable.
