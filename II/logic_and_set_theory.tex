...
Thus what we really want to say is ``the image of a set, under something that looks like a function, is a set.'' See \Cref{sec:classes} for a discussion on how to make this idea concrete using classes.
