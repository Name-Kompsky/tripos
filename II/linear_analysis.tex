...
\begin{theorem}
  There exists a continuous function (\emph{Green function}\index{Green function}) \(k: [a, b] \to \R\) such that the unique solution \(u \in C^2[a, b]\) to the boundary value problem
  \begin{align*}
