...
\begin{proposition}[Ramsey theorem for triangles]\index{Ramsey theorem}
...
\begin{theorem}[Ramsey]\index{Ramsey's theorem}
...
\begin{theorem}[multicolour Ramsey theorem]
