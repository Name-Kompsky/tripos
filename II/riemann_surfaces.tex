...
\begin{definition}[harmonic]\index{harmonic}
...
\[
  2g_X - 2 = 2(-2) + (2g + 2)
\]
so \(g_X = g\). This is a natural generalisation of Fermat curve\index{Fermat curve} and in particular shows that we can construct a Riemann surface with arbitrary genus.
