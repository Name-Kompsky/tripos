...
\begin{theorem}
  Let \(A\) be a \(G\)-module and \(H \normal G\) be a nomrla subgroup. Then there is an \emph{inflation-restriction exact sequence}\index{inflation-restriciton exact sequence}
  \[
    \begin{tikzcd}
...
\begin{theorem}[Wiles, Breuid, Conrad, Diamond, Taylor]
