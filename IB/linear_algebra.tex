...
Lastly,
\begin{theorem}[Diagonalisation of Hermitian Form and Sylvester's Law]\index{tbd}
...
\begin{theorem}[Gram-Schmidt Orthogonalisation Process]\index{Gram-Schmidt}
...
\begin{remark}
  This usage of notation is not entirely coincidental. In fact, let \(V\) and \(W\) be finite-dimensional real inner product space and \(\alpha \in L(V, W)\). In finite dimension there is an isomorphism
  \begin{align*}
    \psi_{R, V}: V &\to V^* \\
    v &\mapsto \ip{-, v}
  \end{align*}
