...
\begin{proof}
  We see the word ``coutable'' and instinctly use induction on \(k\). If \(k = 1\) then done. Suppose we have found \(e_1, \dots, e_k\). Inspired by the orthonormal basis expansion formula, let
  \[
