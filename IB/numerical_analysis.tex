...
\begin{eg}[Legendre polynomials]\index{Legendre polynomial}
...
\begin{eg}[Chebyshev polynomials]\index{Chebyshev polynomial}
...
\subsubsection{Euler method}\index{Euler method}
