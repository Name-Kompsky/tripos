...
Note the loose analogy between Hermtian matrices and self-adjoint operators:
\begin{align*}
...
\begin{align*}
  \int_{a}^{b} y_1\L y_2 dx &= \int_{a}^{b} y_1 \Big[ -\frac{d}{dx} \big(p \frac{dy_2}{dx} \big) + qy_2 \Big] dx \\
                         ...
                         &= \int_{a}^{b} y_2\L y_1 dx + \Big[ p\underbrace{(y_2 \frac{dy_1}{dx} - y_1 \frac{dy_2}{dx})}_{T_1} \Big]^b_a
\end{align*}
Note \(T_1\), the Wronskian.
...
\[
  - \frac{d}{dx}\Big( e^x \frac{dy}{dx} \Big)- \frac{e^xy}{4} = \lambda e^4y
\]
