...
\begin{definition}[Twice differentiability]
...
\begin{proof}
  This seems like a horrible mess but, like many other things we have encountered in this course, its nothing more than theory from IA Analysis I plus definitions. Define
  \[
    f(t) = F(x_0 + tv).
  \]
...
Well this a bewildering section that doesn't seem to go anywhere or belong to any part of this course (or tripos, for that matter), nevertheless it is required by the faculty.\footnote{``All right let's go ahead and get started.''}
