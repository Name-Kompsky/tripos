...
Again this hightlights an idea that permeates this course: from complex analysis alone one gets local results about holomorphic functions. By use topological machinaries such as connectedness, compactness and in this section, homotopy, one can then extend them to global results.
