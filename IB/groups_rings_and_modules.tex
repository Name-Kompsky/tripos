...
\begin{definition}[Unit, divisibility, associates, irreducible, prime]\index{tbd}\leavevmode
  \begin{itemize}
...
\begin{remark}
  Being a unit/irreducible/prime dependes not only on the element but also on the ambient ring: \(2X \in \Z[X]\) is not irreducible but \(2X \in \Q[X]\) is.
\end{remark}
...
\begin{eg}
  ...
  \end{align*}
  so \(N(z) = z\conj z\). Note \(N(r_1r_2) = N(r_1)N(r_2)\). If \(r\) is a unit then there esists \(s \in R\) such that \(rs = 1\), then \(N(r)N(s) = N(1) = 1\), so \(N(r) = 1\). So \(r = a + b \sqrt{-5}\) such that \(a^2 + 5b^2 = 1\). The only possibility is \(r = \pm 1\). Claim that \(2 \in R\) is irreducible:
